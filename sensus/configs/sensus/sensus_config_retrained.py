_base_ = [
    '../_base_/datasets/dair-mono3d.py', 'sensus_model.py',
...
train_dataloader = dict(
    batch_size=6, num_workers=6, dataset=dict(pipeline=train_pipeline))
# batch = 8
...
load_from = '/home/javier/sensus-loci/work_dirs/exp/good/sensus_config_bueno/epoch_100.pth'
