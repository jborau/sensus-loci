_base_ = [
    '../_base_/datasets/dair-mono3d.py', '../_base_/models/pgd.py',
...
train_pipeline = [
    ...
    # dict(type='mmdet.Resize', scale=(1728, 972), keep_ratio=True),
...
train_dataloader = dict(
    batch_size=1, num_workers=3, dataset=dict(pipeline=train_pipeline))
...
train_cfg = dict(max_epochs=48, val_interval=12)
