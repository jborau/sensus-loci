...
optim_wrapper = dict(
    ...
    optimizer=dict(
        type='SGD',
        lr=2.5e-4,  # or another learning rate suitable for your model
        momentum=0.9,  # typical values are between 0.5 and 0.9
        weight_decay=0.0001  # add weight decay if appropriate
    ),
